...
class MAN(object):
    ...
    def index(self, *args, **kwargs):
        outstring = '''
    這是 2015CDA 協同專案下的 cda_g8 模組下的 MAN 類別.<br />
    請依序執行<br /><br />
    <!-- 這裡採用相對連結, 而非網址的絕對連結 (這一段為 html 註解) -->
    <a href="man24">建立本體(24號負責)</a><br />
    <a href="man49">組裝左手和手腕(45號負責)</a><br />
    <a href="man29">組裝右手和手腕(29號負責)</a><br />
    <a href="man51">組裝頭(51號負責)</a><br />
    <a href="man45">組裝帽子(10號負責)</a><br />
    <a href="man45">組裝褲子(50號負責)</a><br />
    <a href="man52">組裝左右腳(49號負責)</a><br />
    <a href="assembly">樂高機器人組立(一次全部)</a><br />
    請確定下列零件於 V:/home/ 目錄中, 且開啟空白 Creo 組立檔案.<br />
    <a href="https://2014cda-mdenfu.rhcloud.com/cmsimply/download/?filepath=/var/lib/openshift/5356315e4382ec2b3f000557/app-root/data//downloads/lego_parts.7z">lego.7z</a>(滑鼠右鍵存成 .7z 檔案)<br />
    請打開creo2檔案，把現在這裡的網址貼到creo內建的IE網站上執行，若無creo請到此下載<br />
    <a href="https://docs.google.com/a/gm.nfu.edu.tw/file/d/0B1DlKZ6juyQeQ0ZMTnBLejJQVkE/edit">creo2_64bit.7z</a><br />
...
for (var i = 0; i < 3; i++)
{
    ...
    if (asmItem == void null)
>>>>>>> ec753707236980ba4416ad17bbee72f9fe1c6950
    {
        var asmcomp = assembly.AssembleComponent (componentModel, transf);
    }
    var ids = pfcCreate("intseq");
...
>>>>>>> ec753707236980ba4416ad17bbee72f9fe1c6950
    ...
    three_plane_assembly2(session, assembly, transf, featID, 6, "LEGO_WAIST.prt", "DTM4", "DTM5", "DTM6", "DTM1", "DTM2", "DTM3"); 
    // 右腳
...
// 紅帽
axis_plane_assembly(session, assembly, transf, first_featID, 5, 
                              "LEGO_HAT.prt", "A_2", "TOP", "A_2", "FRONT"); 
...
var first_featID = components.Item(0).Id;
    ...
    // 利用函式呼叫組立右手 ARM, 組立增量次序為 1
    axis_plane_assembly(session, assembly, transf, first_featID, 0, 
                                  "LEGO_ARM_RT.prt", "A_13", "DTM1", "A_4", "DTM1"
    );
    // 利用函式呼叫組立右手 HAND, 組立增量次序為 3
    axis_plane_assembly(session, assembly, transf, first_featID, 1, 
                                  "LEGO_HAND.prt", "A_2", "DTM2", "A_1", "DTM3");
    // regenerate 並且 repaint 組立檔案
    assembly.Regenerate (void null);
    session.GetModelWindow (assembly).Repaint();    
...
session.GetModelWindow (assembly).Repaint();    
        ...
        return outstring
    @cherrypy.expose
    def man49(self, *args, **kwargs):
        outstring = '''
        '''
        return outstring
    @cherrypy.expose
    def man51(self, *args, **kwargs):
        outstring = '''
        '''
        return outstring
    @cherrypy.expose
    def man52(self, *args, **kwargs):
        outstring = '''
        '''
        return outstring
